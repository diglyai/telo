...
class HttpServerApi implements RuntimeResource {
  constructor(
  ...
  init(ctx: ResourceContext): void | Promise<void> {
    // Initialize the HTTP Server API resource
    // console.log('Initializing HTTP Server API:', this.metadata);
  }

  signal(): void | Promise<void> {}

  teardown(): void | Promise<void> {
    // Teardown the HTTP Server API resource
  }
}
...
export async function create(
  ...
  return new HttpServerApi(resource.kind, resource.metadata);
}
